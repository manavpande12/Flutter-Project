...
import 'package:todo_list_keys/keys/checkable_todo_item.dart';
//import 'package:todo_list_keys/keys/todo_item.dart';
          ...
          child: Column(
            children: [
              ...
              for (final todo in _orderedTodos)
                CheckableTodoItem(
                  key: ValueKey(todo.text), //unique to identify state 
                  todo.text,
                  todo.priority,
                ),
            ],
